...
class Calculator {
    ...
    func add(lhs: UInt32, rhs: UInt32) -> UInt32 {
        return lhs + rhs
    }
    ...
    func subtract(lhs: UInt32, rhs: UInt32) -> UInt32 {
        return lhs - rhs
    }
    ...
    func multiply(lhs: UInt32, rhs: UInt32) -> UInt32 {
        return lhs * rhs
    }
    ...
    func divide(lhs: UInt32, rhs: UInt32) -> UInt32 {
        return lhs / rhs
    }
